    ...
    properties: {
      ...
      insights: {
        ...
        properties: {
          ...
          "Counsellor's Observations": { type: Type.ARRAY, items: { type: Type.STRING } },
          "Referral Details": { type: Type.ARRAY, items: { type: Type.STRING } },
          "Subtext Analysis": { type: Type.ARRAY, items: { type: Type.STRING } },
          "Student Details": { type: Type.ARRAY, items: { type: Type.STRING } },
          "School/Counsellor Details": { type: Type.ARRAY, items: { type: Type.STRING } },
