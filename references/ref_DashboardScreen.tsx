...
export default function DashboardScreen() {
  const { getAccessToken, isHospitalAdmin, adminHospitalId, signOut } = useAuth();
...
function PatientMatrixView({
  ...
  // 5 dashboard categories for columns
