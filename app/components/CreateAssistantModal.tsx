 ...
 *
 * Modal for creating a new assistant with basic profile information.
 * Form fields: full_name, email, qualification (optional)
 */

import { useState, useEffect } from 'react';
import { useAuth } from '@lib/auth';
import { createAssistant } from '@/services/assistantApi';
import { getSchools } from '@/services/counsellorApi';
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          ...
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">
              Common qualifications: RN (Assistant), BSN, LPN, NP, APRN
            </p>
          </div>
